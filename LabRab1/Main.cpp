//25.	Â ñòðîêå â êàæäîé ïàðå ñëîâ ïîìåíÿòü ñëîâà ìåñòàìè, åñëè äëèíû ñëîâ ñîâïàäàþò, èíà÷å çàìåíèòü èõ çâ¸çäî÷êàìè.
// TODO не выполнено условие, что в main только вызовы. Вся реализация функций в ОТДЕЛЬНОМ файле а их объявление в .h
// allocate это не из С++ изменить!!!
...
int main()
{
	...
	while (isRunning)
	{
		...
		{
		case 0:
			cout << "25.Â ñòðîêå â êàæäîé ïàðå ñëîâ ïîìåíÿòü ñëîâà ìåñòàìè, åñëè" << endl << "    äëèíû ñëîâ ñîâïàäàþò, èíà÷å çàìåíèòü èõ çâ¸çäî÷êàìè." << endl << endl;
			break;
		case 1:
			s = allocate(len);
			initStr(s, len);
